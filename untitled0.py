...
st.write("Hello! Welcome to the Predict application. Here you can input the name of a quarterback to see what stats that quarterback is predicted to have for the 2023-2024 season!")
